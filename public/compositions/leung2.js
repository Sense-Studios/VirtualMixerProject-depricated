...
if ( window.mobileAndTabletCheck() ) {
  sourceA = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+Top+FINAL+FINAL+w_+audio_1.mp4"});
  sourceB = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+close+FINAL+FINAL.mp4"});
  sourceC = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+low+FINAL+FINAL_1.mp4"});
}else{
  sourceA = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+Top+FINAL+FINAL+w_+audio_1.mp4"});
  sourceB = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+close+FINAL+FINAL.mp4"});
  sourceC = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+low+FINAL+FINAL_1.mp4"});
}

// source is medium ass trailer (~200mb)
// var sourceA = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+Top+FINAL+FINAL+w_+audio_1.mp4"});
// var sourceB = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+close+FINAL+FINAL_1.mp4"});
// var sourceC = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+low+FINAL+FINAL.mp4"});

// source is medium ass trailer (~400mb)
...
// source is high quality ass trailer (~1.8mb)
//var sourceA = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/TSS+Top+FINAL+FINAL+w_+audio.mp4"});
//var sourceB = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/TSS+close+FINAL+FINAL_1.mp4"});
//var sourceC = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/TSS+low+FINAL+FINAL.mp4"});
...
var setQuality = function(_quality) {
  ...
  if (_quality == "mobile")  {
    sourceA.src('https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+Top+FINAL+FINAL+w_+audio_1.mp4');
    sourceB.src('https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+close+FINAL+FINAL.mp4');
    sourceC.src('https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+low+FINAL+FINAL_1.mp4');
    ...
    sourceA.src('https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+Top+FINAL+FINAL+w_+audio_1.mp4');
    sourceB.src('https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+close+FINAL+FINAL.mp4');
    sourceC.src('https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+low+FINAL+FINAL_1.mp4');


    // source is low ass trailer (~100mb)
    //var sourceA = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+Top+FINAL+FINAL+w_+audio_1.mp4"});
    //var sourceB = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+close+FINAL+FINAL.mp4"});
    //var sourceC = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_1_3_TSS+close+FINAL+FINAL.mp4"});
    // source is medium ass trailer (~200mb)
    // var sourceA = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+Top+FINAL+FINAL+w_+audio_1.mp4"});
    // var sourceB = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+close+FINAL+FINAL_1.mp4"});
    // var sourceC = new VideoSource(renderer, {src: "https://cdn.virtualmixproject.com/veejay/leung/576_3_6_TSS+low+FINAL+FINAL.mp4"});
