...
filemanager1.load_set('/sets/mixkit_co.json')
filemanager2.load_set('/sets/mixkit_co.json')
...
setInterval(function() {
  if ( audioanalysis1.render() > 0.99 && !wasSet ) {
    ...
    if (beats%16 == 0 && dice < 0.52 ) filemanager1.changez(); setTimeout(function() { source1.jump() }, 1500 )
