...
// Node 1
var node = new Node('mixer1');
node.addInput('pod');
node.addInput('mixMode');
node.addInput('blendMode');
node.addInput('bpm');
node.addInput('autoFade');
node.addInput('source 1');
node.addInput('source 2');

// Node 2
var node2 = new Node('source 1');
node2.addInput('currentTime');
node2.addInput('jump');

// Node 3
var node3 = new Node('source 2');
node3.addInput('currentTime');
node3.addInput('jump');
